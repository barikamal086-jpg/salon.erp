...
Usa perfil salvo do Chrome — faz login uma vez, nunca mais precisa repetir.
"""
...
def lancar_receita(page, dados: dict):
    ...
    # Se redirecionou para login, aguarda o usuário logar
    if "login" in page.url.lower() or "auth" in page.url.lower():
        print("\n🔑  Primeira vez: faça login no Chrome que abriu.")
        print("    Após logar, volte aqui e pressione Enter...")
        input()
        page.goto(URL_RECEITAS, wait_until="domcontentloaded", timeout=60_000)
        time.sleep(3)
...
def main():
    ...
    # Abre Chrome com perfil salvo — sessão persiste entre execuções
